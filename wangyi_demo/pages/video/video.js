...
// 获取视频列表数据
  ...
  handleEnded(event){
    let {videoUpdateTime} = this.data;
    let videoId = videoUpdateTime.findIndex(item=>item.vid === event.currentTarget.id)
    videoUpdateTime.splice(videoId,1)
    this.setData({
      videoUpdateTime
    })
  },
